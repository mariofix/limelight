...
from cthulhu.admin.mixins import AdminModelView
...
from limelight.models import Product, Recipe, Ingredient
...
class RecipeAdmin(AppAdmin, AdminModelView):
    name = _("Recipe")
    name_plural = _("Recipes")
    icon = "fa-solid fa-list"
    column_list = [Recipe.name, Recipe.time]
